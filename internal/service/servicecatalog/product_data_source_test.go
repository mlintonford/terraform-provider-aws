...
func TestAccServiceCatalogProductDataSource_nameAndPortfolioName(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_servicecatalog_product.test"
	dataSourceName := "data.aws_servicecatalog_product.test"
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccProductDataSourceConfig_nameAndPortfolioName(rName, domain, acctest.DefaultEmailAddress),
				Check: resource.ComposeTestCheckFunc(
...
func testAccProductDataSourceConfig_nameAndPortfolioName(rName, domain, email string) string {
	return acctest.ConfigCompose(testAccProductPortfolioAssociationConfig_basic(rName, domain, email), `
data "aws_servicecatalog_product" "test" {
  name           = aws_servicecatalog_product.test.name
  portfolio_name = aws_servicecatalog_portfolio.test.name
}
`)
}
